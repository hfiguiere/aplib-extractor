...
pub fn get_str_value(dict: &BTreeMap<String, Plist>,
...
pub fn get_int_value(dict: &BTreeMap<String, Plist>,
                     key: &str) -> Option<i64> {
    match dict.get(key) {
...
pub fn get_uint_value(dict: &BTreeMap<String, Plist>,
                     key: &str) -> Option<u64> {
    match dict.get(key) {
...
pub fn get_bool_value(dict: &BTreeMap<String, Plist>,
                      key: &str) -> Option<bool> {
    match dict.get(key) {
